...
echo "  Examples:"
echo ""
echo "  Run the stebb-bin binary"
echo ""
echo "    ${cmdname} stebb-bin"
echo ""
echo "  Debug the stebb-bin binary in gdb"
echo ""
echo "    ${cmdname} -g stebb-bin -d gdb"
echo ""
echo "  Run stebb-bin under valgrind with arguments"
echo ""
echo "    ${cmdname} -g -d valgrind -a '--tool=memcheck --leak-check=full' stebb-bin"
echo ""
	return 0
}
##########################################################################
